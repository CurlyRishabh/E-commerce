...
function Profile(props){
    ...
    return (
		<div className="flex flex-col items-center rounded-xl bg-slate-100 m-10 w-1/3">
			<img src={props.src} alt="Img" />
			<p>{props.name}</p>
			<p>
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut aliquid et eligendi nam assumenda, voluptatem
